...
public class ClassLoaderTest {
    ...
    public void testSuspendableClassLoadedTwice() {
        ...
        try {
            ...
            Fiber<?> co1 = new Fiber<>((String) null, null, (SuspendableCallable<Object>) null) {
                @SuppressWarnings("RedundantThrows")
                @Override
                protected Object run() throws SuspendExecution, InterruptedException {
            ...
            Fiber<?> co2 = new Fiber<>((String) null, null, (SuspendableCallable<Object>) null) {
                @SuppressWarnings("RedundantThrows")
                @Override
                protected Object run() throws SuspendExecution, InterruptedException {
    ...
    public void testSuperClassesForCorrectMethodDatabase() throws Exception {
        try (URLClassLoader cl = createClassLoaderFor(getTestClassesURL())) {
            ...
            assertSuperClassesBelongToClassLoader(ClassLoader.getPlatformClassLoader(), instrumentor);
